...
void write_pipeline_stats_json(const std::string& path, const PipelineStatsSnapshot& snapshot) {
    ...
    out << "  \"tcp_send_timeouts\": " << snapshot.tcp_send_timeouts << ",\n";
    out << "  \"tcp_send_cancellations\": " << snapshot.tcp_send_cancellations << ",\n";
    out << "  \"tcp_connect_attempts\": " << snapshot.tcp_connect_attempts << ",\n";
    out << "  \"tcp_connect_retries\": " << snapshot.tcp_connect_retries << ",\n";
    out << "  \"camera_capture_timeouts\": " << snapshot.camera_capture_timeouts << ",\n";
    out << "  \"camera_temporary_unavailable\": " << snapshot.camera_temporary_unavailable << ",\n";
    out << "  \"camera_device_errors\": " << snapshot.camera_device_errors << ",\n";
    out << "  \"camera_buffer_error_frames\": " << snapshot.camera_buffer_error_frames << ",\n";
    out << "  \"camera_incomplete_frames\": " << snapshot.camera_incomplete_frames << ",\n";
    out << "  \"camera_consecutive_invalid_peak\": " << snapshot.camera_consecutive_invalid_peak << ",\n";
    out << "  \"camera_invalid_frame_recoveries\": " << snapshot.camera_invalid_frame_recoveries << ",\n";
    out << "  \"camera_invalid_recovery_suppressed_cooldown\": " << snapshot.camera_invalid_recovery_suppressed_cooldown << ",\n";
    out << "  \"camera_invalid_recovery_suppressed_budget\": " << snapshot.camera_invalid_recovery_suppressed_budget << ",\n";
    out << "  \"camera_recovery_attempts\": " << snapshot.camera_recovery_attempts << ",\n";
    out << "  \"camera_recovery_successes\": " << snapshot.camera_recovery_successes << ",\n";
    out << "  \"camera_recovery_failures\": " << snapshot.camera_recovery_failures << ",\n";
